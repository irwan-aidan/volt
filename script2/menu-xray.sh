...
function add-user() {
	...
	echo -e ""
	echo -e ""
	echo -e "Link Direct : vless://$uuid@$domain:443?headerType=none&type=tcp&encryption=none&flow=xtls-rprx-direct&security=xtls&sni=$domain#vless_xtls_Direct_$user"
	echo -e ""
	echo -e "Link Splice : vless://$uuid@$domain:443?headerType=none&type=tcp&encryption=none&flow=xtls-rprx-splice&security=xtls&sni=$domain#vless_xtls_Splice_$user"
